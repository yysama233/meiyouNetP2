...
public class RDTServer {
  ...
  private static DatagramPacket reply(int seqNum,int ackNum, boolean ackFlag,boolean synFlag,boolean finFlag,int rcvw,String data ,InetAddress client_addr, int client_port) throws Exception{
  ...
  private static void connect_client(int seqNum,int ackNum,boolean ackFlag,boolean synFlag,boolean finFlag,int rcvw,String data, InetAddress client_addr, int client_port, DatagramSocket serverSocket) {
      ...
      try {
          ...
          DatagramPacket reply = reply(seqNum, ackNum, ackFlag, synFlag, finFlag, rcvw, data, client_addr, client_port);
      ...
      while (running) {
        ...
        switch(state) {
            case "ConnRequest":
                ...
                connect_client(ackNum, 0, true, true, false, rcvw, "MEISHAONVNIHAO", client_addr, client_port, serverSocket);
            case "ConnSetup" :
              continue;
